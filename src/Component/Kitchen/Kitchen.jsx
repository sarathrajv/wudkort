...
const Kitchen = ({size,handClick,setShow,handleChange}) => {
  ...
  const kitroom =Alldatas.filter((item)=>item.cat==="kit")
  return (
    <div>
...
<KitchenPopup trigger ={buttonpopup} setTrigger={setbuttonpopup}
